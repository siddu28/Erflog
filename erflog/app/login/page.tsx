    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F7F5F0] px-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Erflog</h1>
          <p className="text-gray-600">Career Intelligence Platform</p>
        </div>
        ...
        <p className="text-center text-gray-500 text-sm mt-6">
          AI-powered career automation for the modern professional
        </p>
      </motion.div>
    </div>
  );
